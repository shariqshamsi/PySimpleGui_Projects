...
play_layout = [
    [sg.VPush()],
    [sg.Push(),sg.Text(song_name, font= 'Areil 20'),sg.Push()],
    [sg.VPush()],
    [
        sg.Push(),
        sg.Button(image_data= base_64_image_import('play.png'),key = '-PLAY-', button_color = 'white', border_width = 0),
        sg.Text(' '),
        sg.Button(image_data= base_64_image_import('pause.png'),key = '-PAUSE-', button_color = 'white', border_width = 0),
        sg.Push()
    ],
    [sg.VPush()],
